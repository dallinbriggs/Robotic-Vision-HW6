...
//    Vout.open("VideoOut.avi",CV_FOURCC('M', 'P', 'E', 'G') , 1, Size(640,480),1);
    ...
    header = "/home/dallin/robotic_vision/HW6/Parallel_Cube/ParallelCube";
    tail = ".jpg";

    // Get the first frame features.
    image = imread("/home/dallin/robotic_vision/HW6/Parallel_Cube/ParallelCube10.jpg",CV_LOAD_IMAGE_GRAYSCALE);
    ...
    image_first = imread("/home/dallin/robotic_vision/HW6/Parallel_Cube/ParallelCube10.jpg",CV_LOAD_IMAGE_COLOR);
    image_last = imread("/home/dallin/robotic_vision/HW6/Parallel_Cube/ParallelCube15.jpg",CV_LOAD_IMAGE_COLOR);
